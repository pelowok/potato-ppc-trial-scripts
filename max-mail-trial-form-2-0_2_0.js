...
MktoForms2.whenReady(function (form) {
	...
	var e = document.getElementById("Company_Category_Main__c");
	...
	form.onSuccess(function handleSuccess (values, followUpUrl) {
	    window.dataLayer.push({
	        'event': 'MarketoFormSubmitSuccess',
	        'formID': strFormID
	    });
	    return true; 
	});
